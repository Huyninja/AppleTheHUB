...
if placeId == 6152116144 or placeId == 13883279773 or placeId == 11468159863 or placeId == 13881804983 or placeId == 13883059853 or placeId == 5956785391 or placeId == 11468034852 then
    print('Game Detected -- Project Slayers')
    task.wait(5)
    print('Loading... (1)')
    task.wait(3)
    print('Loading... (2)')
    ...
    print('Loading... (3)')
    task.wait(3)
    print('Welcome', game.Players.LocalPlayer.Character.Name)
    task.wait(3)
    print("Apple HUB -- Project Slayers Script Is Executing")
end
        ...
        Callback = function(value)
            ...
            if TP then
                ...
                local function ImprovedTeleport(Target)
                    ...
                    local PositionDelta = Target -
                        StartingPosition     -- Calculating the difference between the start and end positions.
